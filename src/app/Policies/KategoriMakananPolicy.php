...
class KategoriMakananPolicy
{
    ...
    {
        return $user->can('view_any_kategori::makanan');
    }
    ...
    {
        return $user->can('view_kategori::makanan');
    }
    ...
    {
        return $user->can('create_kategori::makanan');
    }
    ...
    {
        return $user->can('update_kategori::makanan');
    }
    ...
    {
        return $user->can('delete_kategori::makanan');
    }
    ...
    {
        return $user->can('delete_any_kategori::makanan');
    }
     ...
     */
    public function replicate(User $user, KategoriMakanan $kategoriMakanan): bool
    {
