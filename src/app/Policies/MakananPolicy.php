...
class MakananPolicy
{
    ...
    {
        return $user->can('view_any_makanan');
    }
    ...
    {
        return $user->can('create_makanan');
    }
    ...
    {
        return $user->can('update_makanan');
    }
    ...
    {
        return $user->can('delete_makanan');
    }
    ...
    {
        return $user->can('delete_any_makanan');
    }
     ...
     */
    public function replicate(User $user, Makanan $makanan): bool
    {
